...
clone_and_setup_code() {
	sudo mkdir -p /home/ufreshcorp-mc/htdocs/mc.ufreshcorp.com
    cd /home/ufreshcorp-mc/htdocs/mc.ufreshcorp.com
	...
	chown -R $USER:www-data /home/ufreshcorp-mc/htdocs/mc.ufreshcorp.com*
}

# Function to add the cron job to the crontab
add_cron_job() {
    echo "Adding cron job to execute MineTrax schedule..."
    (crontab -l ; echo "* * * * * php /home/ufreshcorp-mc/htdocs/mc.ufreshcorp.com/artisan schedule:run >> /dev/null 2>&1") | crontab -
...
command=php /home/ufreshcorp-mc/htdocs/mc.ufreshcorp.com/artisan queue:work --sleep=3 --tries=3 --max-time=3600
autostart=true
autorestart=true
stopasgroup=true
killasgroup=true
...
process_name=%(program_name)s_%(process_num)02d
command=php /home/ufreshcorp-mc/htdocs/mc.ufreshcorp.com/artisan queue:work --queue=longtask,default redis-longtask --timeout=0 --sleep=3 --tries=3 --max-jobs=500
autostart=true
autorestart=true
stopasgroup=true
killasgroup=true
...
setup_nginx_config() {
    ...
    sudo sed -i "s#APP_URL=http://localhost#APP_URL=http://$domain_name#" /home/ufreshcorp-mc/htdocs/mc.ufreshcorp.com/.env
    ...
    root /home/ufreshcorp-mc/htdocs/mc.ufreshcorp.com/public;
...
# Check if /home/ufreshcorp-mc/htdocs/mc.ufreshcorp.com directory doesn't exist or is empty
if [ ! -d "/home/ufreshcorp-mc/htdocs/mc.ufreshcorp.com" ] || [ -z "$(ls -A /home/ufreshcorp-mc/htdocs/mc.ufreshcorp.com)" ]; then
	setup_database
    ...
    echo "ERROR: The /home/ufreshcorp-mc/htdocs/mc.ufreshcorp.com directory already exists and is not empty. Skipping MineTrax setup."
fi
